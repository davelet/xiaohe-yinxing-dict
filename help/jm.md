...
- 次选：66个
  ...
  忍扔寺涩诉淘替舔通退室 省守症终遮文忘玩未心型 凶野杨严园友遭揍坐飞韩
    ...
    > [<二简次选>](wt.md#qm) 字为备选分类，通过直通 `oej` 启用

2. **二简词：**  两码二字词（取两字的首码即声声），共370个
...
> <span style="color: #D9534F;">前三排可以重点熟悉下，其他使用中积累就好</span>
...
<span id="jj" style="color: #D9534F;"></span>
#### 四、入门捷径
